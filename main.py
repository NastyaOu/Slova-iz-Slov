                ...
                if event.button == pygame.BUTTON_LEFT:
                    ...
                    if accept.rect.collidepoint(mouse_pos):
                        ...
                        for dictionary_element in dictionary:
                            if dictionary_element['source'] == word:
                                found = True
                                for type_elem in dictionary_element['type']:
                                    words.append(type_elem.upper())
                                break
                        ...
                        if not found:
                            ...
                            print_text(screen, 500, 400, 'Слово не найдено!', 48)
                            pygame.display.flip()
...
def show_game():
    ...
    if level != 0 and (len(results) == 40 or len(words) == 0):
        forward = ImageButton(1137, 40, 103, 55, forward_img)
        all_sprites.add(forward)
